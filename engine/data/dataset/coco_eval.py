...
class CocoEvaluator(object): 
    ...
    def __init__(self, coco_gt, iou_types, eval_spatial_size=None, eval_mask_ratio=1, using_tiny_metrice=False, using_vtiny_metrice=False, max_dets=100):   
        ...
        for iou_type in iou_types:  
            ...
            self.coco_eval[iou_type] = COCOeval(
                copy.deepcopy(self.coco_gt[iou_type]),    
                iouType=iou_type,  
                using_tiny_metrice=self.using_tiny_metrice,   
                using_vtiny_metrice=self.using_vtiny_metrice,
