'''    
本文件由BiliBili：魔傀面具整理
engine/extre_module/module_images/ICML2026-PolyMLP.png
engine/extre_module/module_images/ICML2026-PolyMLP.md
...
if __name__ == '__main__':
    ...
    module = PolyMLP(in_features=in_channel, hidden_features=hidden_channel, out_features=out_channel).to(device)
