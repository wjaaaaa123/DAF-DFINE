...
from engine.extre_module.custom_nn.conv_module.FADC import (
    AdaptiveDilatedConv,
)

#from ..extre_module.custom_nn.mlp.ConvolutionalGLU import ConvolutionalGLU

__all__ = ["HybridEncoderFADC"]    
...
@register()
class HybridEncoderFADC(nn.Module):
    ...
    def __init__(self,     
        ...
        for in_channel in in_channels:
            ...
            self.input_proj.append(proj)   
                ...
                # 单模块实验：只添加一个FADC
        # 输入和输出通道均为hidden_dim，保持特征尺寸和通道不变
        self.fadc = AdaptiveDilatedConv(
    ...
    def forward(self, feats):
        ...
        # 只增强P4特征
        proj_feats[0] = self.fadc(proj_feats[0])
